$(document).ready(function() {
   ...
   *Random quotes
   **/
  $.getJSON("http://crossorigin.me/https://quotesondesign.com/wp-json/posts?filter[orderby]=rand&filter[posts_per_page]=1&callback=", function(a) {
  ...
  $.getJSON("https://freegeoip.net/json/", function(json) {
    $.getJSON("https://api.openweathermap.org/data/2.5/weather?lat=" + json.latitude + "&lon=" + json.longitude + "&units=imperial&appid=03f010544045f1772f781cfaf70d9cdd", function(x) {
      ...
      $("#weather").html(" <div><img src='https://openweathermap.org/img/w/" + x.weather[0].icon + ".png'/><span style='float:right; vertical-align:bottom;'> | " + f + "&deg; F</span></div>");
    });
  });
  /***
   *TODO widget
